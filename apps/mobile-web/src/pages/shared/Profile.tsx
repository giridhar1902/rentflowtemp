...
const Profile: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Profile Card */}
      <div className="relative overflow-hidden rounded-[24px] border border-primary/30 bg-white p-6 shadow-sm flex flex-col items-center gap-4 group">
        <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-[#F5A623] to-[#F5A623] opacity-80"></div>

        <div className="flex h-24 w-24 items-center justify-center rounded-full border-[3px] border-primary bg-white text-[32px] font-black text-primary shadow-[0_4px_15px_rgba(245,166,35,0.2)] group-hover:scale-105 transition-transform duration-300">
          {(
            profile?.firstName?.[0] ??
            profile?.email?.[0] ??
            "U"
        ...
        <div className="rounded-[24px] border bg-white overflow-hidden shadow-sm">
          <div className="flex flex-col">
            <button
              ...
              className="flex w-full items-center gap-4 border-b p-4 text-left  active:bg-white transition-all group"
            >
              <div className="flex size-10 items-center justify-center rounded-full bg-white border shadow-inner group-hover:bg-primary/10 transition-colors">
            ...
            <button
              ...
              className="flex w-full items-center gap-4 p-4 text-left  active:bg-white transition-all group"
            >
              <div className="flex size-10 items-center justify-center rounded-full bg-white border shadow-inner group-hover:bg-primary/10 transition-colors">
                <span className="material-symbols-outlined text-[20px] text-text-secondary group-hover:text-primary transition-colors">
                  notifications
      ...
      <section className="flex flex-col gap-3">
        ...
        <div className="rounded-[24px] border bg-white p-4 shadow-sm flex items-center justify-between gap-3">
          <div>
          ...
          <div className="shrink-0 bg-white p-1 rounded-[16px] border shadow-inner">
            <ThemeModeToggle />
          </div>
        </div>
      </section>
