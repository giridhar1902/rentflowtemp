    ...
    <div className="min-h-screen font-sans pb-[100px] text-text-primary selection:bg-primary/30">
      ...
      <main className="px-5 pt-6 pb-8 flex flex-col gap-6 motion-page-enter">
        ...
        {isLoading ? (
          ...
          <>
            {showForm && (
              <div className="rounded-[24px] border bg-white p-6 shadow-sm flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="w-full appearance-none rounded-[16px] border bg-white py-3.5 pl-4 pr-10 text-[14px] font-bold text-text-primary outline-none focus:border-primary focus:bg-white/80 focus:ring-1 focus:ring-primary shadow-inner transition-all"
                    >
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    className="w-full rounded-[16px] border bg-white py-3.5 px-4 text-[14px] font-bold text-text-primary outline-none focus:border-primary focus:bg-white/80 focus:ring-1 focus:ring-primary shadow-inner transition-all"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      placeholder="Visa, MC"
                      className="w-full rounded-[16px] border bg-white py-3.5 px-4 text-[14px] font-bold text-text-primary outline-none focus:border-primary focus:bg-white/80 focus:ring-1 focus:ring-primary shadow-inner transition-all placeholder:text-text-secondary/50"
                    />
                  </div>
                </div>
                ...
                <label className="flex items-center gap-3 cursor-pointer mt-2 w-max group">
                  <div
                    className={`flex size-5 items-center justify-center rounded-[6px] border shadow-sm transition-colors ${isDefault ? "bg-primary border-primary" : "bg-white group-hover:border-primary/50 shadow-inner"}`}
                  >
                    {isDefault && (
                ...
                <button
                  ...
                  className="mt-2 flex w-full items-center justify-center gap-2 rounded-full bg-gradient-to-r from-[#F5A623] to-[#F5A623] py-3.5 text-[14px] font-bold uppercase tracking-[0.1em] text-white shadow-[0_4px_15px_rgba(245,166,35,0.3)] hover:opacity-90 active:scale-[0.98] transition-all disabled:opacity-50 disabled:hover:scale-100 disabled:active:scale-100"
                >
                  {isSubmitting ? (
            ...
            {defaultMethod && !showForm && (
              <div className="relative overflow-hidden rounded-[24px] border border-primary/30 bg-primary/5 p-6 shadow-sm  group">
                ...
                <div className="relative rounded-[20px] border bg-white  shadow-inner p-5 pb-6">
            ...
            <section className="flex flex-col gap-3">
              ...
              {methods.length === 0 ? (
                <div className="rounded-[20px] border bg-white shadow-sm p-6 text-center">
                ...
                <div className="flex flex-col gap-3">
                  {methods.map((method) => (
                    <div
                      key={method.id}
                      className="rounded-[20px] border bg-white shadow-sm p-4 flex items-center justify-between gap-3 group transition-all "
                    >
                      <div className="flex items-center gap-4">
                        <div className="flex size-10 items-center justify-center rounded-full bg-white border shadow-inner text-text-secondary group-hover:text-primary group-hover:bg-primary/10 transition-colors">
                          <span className="material-symbols-outlined text-[20px]">
                            {method.type === "CARD"
                              ? "credit_card"
                      ...
                      <div className="flex items-center gap-2">
                        {method.isDefault ? (
                          ...
                          <button
                            ...
                            className="bg-white text-text-secondary border shadow-sm hover:bg-primary/10 hover:text-primary hover:border-primary/30 px-3 py-1.5 rounded-[12px] text-[11px] font-bold uppercase tracking-wider transition-all active:scale-[0.98]"
                          >
                            Set Default
                          </button>
                        )}
              ...
              {payments.length === 0 ? (
                ...
                <div className="rounded-[24px] border bg-white overflow-hidden shadow-sm">
                  {payments.slice(0, 5).map((payment) => (
                    <div
                      key={payment.id}
                      className="flex items-center justify-between gap-3 border-b px-5 py-4 last:border-b-0 group  active:bg-white transition-all cursor-default"
                    >
                      <div className="flex items-center gap-3">
                        <div className="flex size-10 items-center justify-center rounded-full bg-white border shadow-inner text-text-secondary group-hover:bg-primary/10 group-hover:text-primary transition-colors">
